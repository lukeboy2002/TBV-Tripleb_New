            ...
            <div class="relative overflow-x-auto shadow-md">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <div class="flex items-center">
                                <button wire:click="sortBy('invited_by')" class="uppercase">Invited by</button>
                                <x-icons.sort-icon
                                    field="invited_by"
                                    :sortField="$sortField"
                                    :sortAsc="$sortAsc"
            ...
            <div class="sm:flex sm:items-start">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white" id="modal-title">Delete Invitation</h3>
                        <div class="mt-2">
