<div>
    @if (!$posts->isEmpty())
        <div class="overflow-x-auto relative shadow-md">
            <div class="flex justify-between items-center space-x-4 pb-4 pt-2 px-2">
                ...
                <div class="pr-2">
                    <x-link.btn-primary href="{{ route('admin.posts.create') }}" class="px-5 py-2.5 text-sm font-medium">New post</x-link.btn-primary>
                </div>
            </div>
    ...
    @else
        <div class="overflow-x-auto relative shadow-md">
            <div class="flex justify-end items-center space-x-4 pb-4 pt-2 px-2">
                <div class="pr-2">
                    <x-link.btn-primary href="{{ route('admin.posts.create') }}" class="px-5 py-2.5 text-sm font-medium">New post</x-link.btn-primary>
                </div>
            </div>
